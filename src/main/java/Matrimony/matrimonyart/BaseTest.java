...
public static String getExcelControl(String sheetName, int rowNum, int colNum) throws Throwable{
...
public static int getExcelIntControl(String sheetName, int rowNum, int colNum) throws Throwable{
	FileInputStream fis = new FileInputStream("D:\\Java\\Window7\\First\\matrimonyart\\Excel\\ControlSection.xlsx");
 Workbook wb = WorkbookFactory.create(fis);
 Sheet sh = wb.getSheet(sheetName);
 Row row = sh.getRow(rowNum);
...
public static int getControlRow() throws Throwable{
	FileInputStream fis = new FileInputStream("D:\\Java\\Window7\\First\\matrimonyart\\Excel\\ControlSection.xlsx");
 Workbook wb = WorkbookFactory.create(fis);
 Sheet sh = wb.getSheet("Control");
 int data = (int) sh.getRow(1).getCell(1).getNumericCellValue();
 return data;
}
