	...
	public void setup6() throws Throwable 
	{
		...
		try {
			...
			try {
				...
				Thread.sleep(5000);
				WebElement Any = driver.findElement(By.xpath("//*[text()='"+BaseTest.getExcelControl("Sheet1", 1, 6)+"']"));
		...
		try {
			...
			try {
				...
				Thread.sleep(5000);
				WebElement Any = driver.findElement(By.xpath("//*[text()='"+BaseTest.getExcelControl("Sheet1", 1, 8)+"']"));
